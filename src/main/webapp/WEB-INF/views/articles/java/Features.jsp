...
<div id="keys">Java Features,자바의 특징,Platform Independent,플랫폼 독립적,bytecode,바이트코드,JRE,자바 실행 환경,JVM,자바 가상 머신,JDK,OOP,객체 지향 프로그래밍,Object,객체,Encapsulation,캡슐화,Inheritance,상속,Polymorphism,다형성</div>
<div id="desc">이 문서는 자바 특징에 대해 설명합니다.</div>
